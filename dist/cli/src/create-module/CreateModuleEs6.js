...
var CreateModuleEs6 = (function () {
    function CreateModuleEs6() {
        this.indexTemplate = new template_1.FileTemplate(this.getTemplatePath("es6/index.template.txt"));
        this.moduleTemplate = new template_1.FileTemplate(this.getTemplatePath("es6/module.template.txt"));
        this.rootTemplates = [];
        this.rootTemplates.push({
            template: new template_1.FileTemplate(this.getTemplatePath("es6/package.json.template.txt")),
